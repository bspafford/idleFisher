...
public:
	...
	void drawFishingLine(SDL_Renderer* renderer);
	...
	static inline float fishSchoolMultiplier; // increases the fish caught
	static inline float fishTimeMultiplier; // reduces the catch time
...
public:
	...
	static inline std::unique_ptr<Fimg> bobberImg;
	static inline std::unique_ptr <Fimg> bobberWaterOverlay;
