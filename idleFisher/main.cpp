...
void Main::Start() {
	...
	// load idle profits
	loadIdleProfits();
	if (world::autoFisherList.size() > 0 && SaveData::saveData.mechanicStruct[0].unlocked) { // if has atleast 1 autofisher and has fish transporter
...
void Main::Update(float deltaTime) {
	...
	collision::testCCD(character->col, move, deltaTime);
...
void Main::draw(Shader* shaderProgram) {
	...
	if (currWorld == "titleScreen")
		titleScreen::draw(shaderProgram);
		...
		world1::draw(shaderProgram);
	} else if (currWorld == "world2")
		world2::draw(shaderProgram);
	else if (currWorld == "world3")
		world3::draw(shaderProgram);
	else if (currWorld == "world4")
		world4::draw(shaderProgram);
	else if (currWorld == "world5")
		world5::draw(shaderProgram);
	else if (currWorld == "world6")
		world6::draw(shaderProgram);
	else if (currWorld == "world7")
		world7::draw(shaderProgram);
	else if (currWorld == "world8")
		world8::draw(shaderProgram);
	else if (currWorld == "world9")
		world9::draw(shaderProgram);
	else if (currWorld == "world10")
		world10::draw(shaderProgram);
...
void Main::keyCallback(GLFWwindow* window, int key, int scancode, int action, int mods) {
	...
	if (action == GLFW_PRESS && key != -1) {
		if (key == GLFW_KEY_ESCAPE && currWorld != "titleScreen") {
		...
		if (key == GLFW_KEY_C && currWorld != "titleScreen")
			achievementWidget->addToViewport(true);
		if (key == GLFW_KEY_V && currWorld != "titleScreen")
