...
Ujournal::Ujournal() {
	background = new Image("./images/widget/journal.png", { 0, 0 }, false);
	journalClosed = new Image("./images/widget/journalClosed.png", { 0, 0 }, false);

	std::unordered_map < std::string, animDataStruct> anim;
	anim.insert({ "open", { {0, 0}, {5, 0}, .1, false} });
	anim.insert({ "close", { {0, 1}, {5, 1}, .1, false} });
	journalAnim = new animation("widget/journalOpen.png", 282, 240, anim, false, { 0, 0 });
	...
	// selected fish page
	fishThumbnail = new Image("", { 0, 0 }, false);
	notesBackground = new Image("./images/widget/journalNotes.png", { 0, 0 }, false);
	...
	star1 = new Image("./images/emptyStar.png", { 0, 0 }, false);
	star1Text = new text("0", "straight", { 0, 0 }, false, false, textAlign::center);
	star1Text->setTextColor(85, 177, 241);
	star2 = new Image("./images/emptyStar.png", { 0, 0 }, false);
	star2Text = new text("0", "straight", { 0, 0 }, false, false, textAlign::center);
	star2Text->setTextColor(85, 177, 241);
	star3 = new Image("./images/emptyStar.png", { 0, 0 }, false);
	star3Text = new text("0", "straight", { 0, 0 }, false, false, textAlign::center);
...
void Ujournal::openFishPage(FfishData* fishData, FsaveFishData* saveFishData) {
	...
	delete map;
	map = new Image("./images/widget/maps/" + fishData->levelName + ".png", { 0, 0 }, false);
...
void Ujournal::addedToViewport() {
	std::cout << "open: " << open << ", opening: " << opening << ", closing: " << closing << std::endl;
	if (opening || closing)
		return;
...
void Ujournal::removeFromViewport() {
	std::cout << "removing from viewport\n";
	closing = false;
	opening = false;
	open = false;
	journalTimer->stop();
