...
void UUIWidget::updateButtonsLoc() {
	...
	for (int i = 0; i < buttonsList.size(); i++) {
		...
		buttonsList[i]->getButtonImg()->setColorMod(glm::vec4(glm::vec3(1.f), alpha));
	}
}
