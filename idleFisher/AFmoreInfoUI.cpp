...
AFmoreInfoUI::AFmoreInfoUI(AautoFisher* autoFisher) {
	...
	background = new Image("./images/autoFisher/moreUI/UI.png", { 0, 0 }, false);
	...
	levelBar = new Image("./images/autoFisher/moreUI/level/level1.png", { 0, 0 }, false);
	fullnessBar = new Image("./images/autoFisher/moreUI/fullness/fullness1.png", { 0, 0 }, false);
