...
UupgradeBox::UupgradeBox(widget* parent, FbaitStruct* baitStruct, FsaveBaitStruct* saveBaitStruct) {
	...
	thumbnail = new Image(baitStruct->thumbnail, { 0, 0 }, false);
...
UupgradeBox::UupgradeBox(widget* parent, FpetStruct* petStruct, FsavePetStruct* savePetStruct) {
	...
	thumbnail = new Image("./images/pets/" + std::to_string(petStruct->id) + ".png", { 0, 0 }, false);
...
void UupgradeBox::setup() {
	...
	thumbnailBackground = new Image("./images/widget/thumbnailBackground.png", { 0, 0 }, false);
	name = new text(nameString, "straightDark", { 0, 0 });

	buyButton = new Ubutton(widgetParent, "widget/upgradeButton.png", 37, 16, 2, { 0, 0 }, false, false);
	...
	currencyImg = new Image("./images/currency/coin" + std::to_string(*currencyId) + ".png", { 0, 0 }, false);
