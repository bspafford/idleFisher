...
public:
	...
	static glm::vec4 GetPixelColor(unsigned char* bytes, bool useAlpha, const int X, const int Y);
	static glm::vec4 GetPixelColor(Image* img, const int X, const int Y);
