...
animation::animation(std::string spriteSheetPath, int cellWidth, int cellHeight, std::unordered_map<std::string, animDataStruct> animData, bool useWorldLoc, vector loc) {
	...
	spriteSheet = new Image("./images/" + spriteSheetPath, loc, useWorldLoc);
...
animation::animation(Image* spriteSheetImg, int cellWidth, int cellHeight, std::unordered_map<std::string, animDataStruct> animData, bool useWorldLoc, vector loc) {
	this->cellWidth = cellWidth;
	this->cellHeight = cellHeight;
	this->animData = animData;
	this->loc = loc;
	...
	Rect source = { 0, 0, spriteSheetImg->w, spriteSheetImg->h };
	spriteSheet = new Image(spriteSheetImg, &source, loc, useWorldLoc); // create new own instance of image
