...
UachievementBox::UachievementBox(int id) {
	...
	if (saveAchievementStruct->unlocked) {
		icon = new Image("./images/widget/achievementIcons/achievementIcon" + std::to_string(id + 1) + ".png", { 0, 0 }, false);
	} else
		icon = new Image("./images/widget/achievementIcons/locked.png", { 0, 0 }, false);
